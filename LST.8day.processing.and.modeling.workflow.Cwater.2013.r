...
library(zoo)
 ...
 # LST.in <- read.dbf("CW_11_LST.dbf")
  ...
  LST.in$POINTID[14990] <- 14990
  LST.in$POINTID[14991] <- 14991
  LST.in$POINTID[14992] <- 14992
  LST.in$POINTID[14993] <- 14993
...
#################################################################
  ...
  Log.in <- read.csv("CW_CBS_2013_logger_data.csv", stringsAsFactors = FALSE)
