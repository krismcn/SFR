...
##########################################################
  ...
  write.csv(x = Logger, file = paste0(basin, "_", yearPath, "_Mx_8Day_logger_data.csv"), row.names = F)
...
##########################################################
  ...
  Log.in <- read.csv(file = paste0(basin, "_", yearPath, "_Mx_8Day_logger_data.csv"), stringsAsFactors = FALSE)
  ...
  NoNA.xyz <- NoNA.xyz[,c(12, 2, 1, 3, 4)]
...
summer <- subset(NoNA.xyz, z > 173 & z < 265)
