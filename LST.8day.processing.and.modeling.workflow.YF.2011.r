...
write.dbf(rca_zonal, file = "LST11_YF_RCA.dbf")
...
setwd("D:/OneDrive/work/research/CHaMP/CHaMP_data/EP_temp/YF/")
  ...
  coeffs.in <- read.csv("D:/OneDrive/work/research/CHaMP/CHaMP_data/EP_temp/USalmon/2011/All_data_2011_mod_coeffs_Mx_6Nov15.csv")
  ...
  write.dbf(LogPred.out, file = "predt2011_YF_8D_Max_summer.dbf") 
...
# summary by AU -----------------------------------------------------------
  ...
  colnames(SumSummAU) <- c("RCAID", "PctDays12","PctDays13", "PctDays16", "PctDays18", "PctDays20", "PctDays22",  "MxMx", "sdMn", "MnMx", "STHD", "CHNK", "AU_Code")
  v12DMn = NULL
  v13DMn = NULL
  v16DMn = NULL
  v18DMn = NULL
...
write.csv(SumAU.out, file = "USal_AU_2011_21Jul_31Aug_ExPcnt_summary_All.csv", row.names = F)

#______________________
# went back and calc-ed the model metrics for sping & fall together:
# The YF model data was just updated into the USal data for 2011

  setwd("D:/OneDrive/work/research/CHaMP/CHaMP_data/EP_temp/USalmon/2011/")
  
  Log.in <- read.csv("USal_2011_8Day_model_data.csv")
  NoNA.xyz <- Log.in[,c(11,2:5)]
  colnames(NoNA.xyz) <- c("y", "z", "x", "e", "SiteName")
  ...
  sites <- unique(NoNA.xyz$SiteName)
