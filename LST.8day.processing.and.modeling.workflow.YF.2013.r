...
dataDir <- "D:/OneDrive/work/research/CHaMP/GIS/LST/LST_s1_2013/"
...
###################################
  ...
  plot(pred.y, y, main = "8-day Mean stream temperature (Fall Leg)", xlab="Predicted ('C)", ylab="Observed ('C)", pch=16, col="blue")
  abline(0,1, col="blue")
  post_mod <- summary(lm(y ~ pred.y))
