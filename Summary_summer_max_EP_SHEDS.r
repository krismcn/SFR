...
mainPath <- "D:/OneDrive/work/research/CHaMP/CHaMP_data/Tucannon/SHEDS/"
setwd(mainPath)

 
  Max.in <- read.dbf("predt2013_Tuc_SHEDS_8D_Max_summer.dbf") 
...
# count of days in exceedence -----------------------------------------
  ...
  #colnames(SumSumm.out)[1] <- "RCAID"
  write.dbf(SumSumm.out, file = "Tuc_2013_21Jul_31Aug_max_summary_SHEDS.dbf")
  write.csv(SumSumm.out, file = "Tuc_2013_21Jul_31Aug_max_summary_SHEDS.csv", row.names = F)
...
write.csv(SumAU.out, file = "Tuc_AU_2013_21Jul_31Aug_ExCnt_summary_CHNK.csv", row.names = F)
