# Spatially-explicit stream temperature modeling

This repository includes R code used to model stream temperature in watersheds in the Interior Columbia River Basin.
...
```
$ git clone https://krismcn@bitbucket.org/krismcn/work.git/wiki
```
